...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (unlockedSecretWeek) {
			...
			weekUnlocked = [true, true, true, true, true, true, true, true, false];
		}
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		intendedScore = Highscore.getWeekScore(curWeek, sprDifficulty.animation.curAnim.name.toLowerCase());
